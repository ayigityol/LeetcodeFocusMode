...
document.addEventListener('DOMContentLoaded', function() {
  ...
  chrome.storage.local.get(['focusModeEnabled', 'theme'], function(result) {
    ...
    // Handle the theme toggle (sun/moon)
